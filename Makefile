...
IMG ?=docker.qiniu.io:32500/controller:latest
...
manifests: controller-gen ## Generate WebhookConfiguration, ClusterRole and CustomResourceDefinition objects.
	...
	kubectl kustomize cmd/deploy > operator.yaml
	kubectl kustomize cmd/deploy/snapshotter/ > snapshotoperator.yaml
...
build: generate fmt vet ## Build manager binary.
	...
	CGO_ENABLED=0 GOOS=linux go build -a -installsuffix cgo -o bin/manager main.go
