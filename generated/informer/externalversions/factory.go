...
import (
	...
	rio "qiniu.io/rio-csi/generated/informer/externalversions/rio"
...
func (f *sharedInformerFactory) Rio() rio.Interface {
	return rio.New(f, f.namespace, f.tweakListOptions)
}
